...
impl ChatComposer {
    ...
    #[allow(dead_code)]
    fn _upstream_cursor_pos(&self, area: Rect) -> Option<(u16, u16)> {
    ...
    fn footer_props(&self) -> FooterProps {
        ...
        FooterProps {
            ...
            collaboration_modes_enabled: self.collaboration_modes_enabled,
            is_wsl,
            // @cometix: when cxline is enabled, hide upstream context display
    ...
    fn build_cxline_line(&self) -> ratatui::text::Line<'static> {
        ...
        build_statusline(&self.statusline_config, &ctx).render_line()
    }
...
impl Renderable for ChatComposer {
    fn cursor_pos(&self, _area: Rect) -> Option<(u16, u16)> {
        // @cometix: hide native terminal cursor
        None
    }
...
impl ChatComposer {
            ...
            ActivePopup::None => {
                ...
                if let Some(line) = self.history_search_footer_line() {
                    ...
                    let combined_status_line = if status_line_active {
                        // @cometix: skip .dim() when cxline is active
    ...
    fn render_textarea(
        ...
        // @cometix: border lines instead of Block background
