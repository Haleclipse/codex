...
pub(crate) struct ChatWidget {
    ...
    reasoning_translator: crate::translation::ReasoningTranslator,
...
impl ChatWidget {
    ...
    pub(crate) fn refresh_status_line(&mut self) {
        ...
        // @cometix: trigger git preview for cxline
    ...
    // @cometix: delegate statusline config to bottom pane
    ...
    // @cometix: delegate statusline git preview to bottom pane
    ...
    // @cometix: delegate translation config to reasoning translator
    ...
    // @cometix: process translation draw tick (drain results + handle timeouts)
    ...
    fn on_agent_reasoning_final(&mut self) {
        self.on_agent_reasoning_final_inner(false);
    }

    fn on_agent_reasoning_final_from_replay(&mut self) {
        self.on_agent_reasoning_final_inner(true);
    }
    ...
    fn new_with_op_target(common: ChatWidgetInit, codex_op_target: CodexOpTarget) -> Self {
        ...
        let mut widget = Self {
            ...
            // @cometix: initialize translation orchestrator from config
            reasoning_translator: crate::translation::ReasoningTranslator::from_config(
    ...
    pub(crate) fn handle_server_notification(
        ...
        match notification {
            ...
            ServerNotification::AccountRateLimitsUpdated(notification) => {
                self.on_rate_limit_snapshot(Some(notification.rate_limits));
            }
